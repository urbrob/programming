...
# Przykladowe dodanie nowego pacjenta
# c.execute("INSERT INTO patients VALUES ('97071322512', 'Ula', 'Bogdanecka', 'Wlokniarzy 17', 30)

# Przykładowe pobranie wszystkich pacjetnów
